...
export const PROJECTS: Project[] = [
  {
    ...
    stack: ['Python', 'TensorFlow', 'FastAPI', 'Blockchain', 'Redis'],
    status: 'LIVE',
    ...
    impact: '~94% detection accuracy in testing, ~35% reduction in false positives vs baseline. Published as peer-reviewed research (ISSN 2980-7840).',
    github: 'https://github.com/HARSHHLEDWANI',
    live: 'https://secure-flow-inky.vercel.app',
